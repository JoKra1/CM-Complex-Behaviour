...
//        hideDrawnCardInfoButton()
    ...
    @IBOutlet var deckViewLocationConstraints: [NSLayoutConstraint]!
...
//
    ...
    func runConstraintFactory() -> [Player:[NSLayoutConstraint]] {
        // center to drawn card area position constaint
        var centerToDrawnConstraints: [Player:[NSLayoutConstraint]] = [:]
        
        for (constraintCollectionName, toItem) in [Player.player:playerDrawnCardView, Player.leftModel:leftModelDrawnCardView, Player.topModel:toptModelDrawnCardView, Player.rightModel:rightModelDrawnCardView] {
    ...
    var deckToDrawnLocationConstraints: [Player:[NSLayoutConstraint]] { return runConstraintFactory() }
