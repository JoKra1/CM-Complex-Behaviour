...
class InfoText {
    ...
    private let cardInfo = [
        ...
        "twice":"You have drawn a \"draw 2\" card, allowing you to draw two more cards. Tap the card to make use of this action, you can then draw a new card. If you do not wish to use this action card, tap the discard pile to get rid of it.",
    ...
    private let gameInfo: [GameState:String] = [
        ...
        .drawn:"You have drawn a card. Tap the info icon next to the card you drew to learn what you can do with it. If you wish to discard the card, you can tap the discard pile.",
